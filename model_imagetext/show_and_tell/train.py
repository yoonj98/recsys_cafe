...
def main(args):
    ...
    cocoimgs=pd.DataFrame(cocoimgs).reset_index(drop=True)
    ...
    train_imgs=json.loads(train_imgs.to_json())
    val_imgs=json.loads(val_imgs.to_json())
    test_imgs=json.loads(test_imgs.to_json())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--crop_size', type=int, default=124, help='size for randomly cropping images')
    parser.add_argument('--vocab_path', type=str, default='/home/wondo94/0conf/20210520 image captioning/radcap_project-master/data_preprocessing/vocab.pkl', help='path for vocabulary wrapper')
    parser.add_argument('--image_dir', type=str, default='/home/wondo94/0conf/20210520 image captioning/radcap_project-master/data/Images/', help='directory for resized images')
    parser.add_argument('--caption_path', type=str, default='/home/wondo94/0conf/20210520 image captioning/radcap_project-master/data_preprocessing/',
