...
def build_vocab(json_path, count_thr):
    ...
    counts = {}
    for sent in json_data['caption'].values():
...
if __name__ == '__main__':
    ...
    parser.add_argument('--caption_path', type=str,
                        default='/home/wondo94/0conf/20210520 image captioning/radcap_project-master/data_preprocessing/caption.json',
                        help='path for train annotation file')
    parser.add_argument('--vocab_path', type=str, default='/home/wondo94/0conf/20210520 image captioning/radcap_project-master/data_preprocessing/vocab.pkl',
